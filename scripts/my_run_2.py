...
if __name__ == "__main__":
    ...
    world_name = "BARN/world_%d.world" %(args.id)
    ...
    path_file_name = join(base_path, "worlds/BARN/path_files", "path_%d.npy" %args.id)
    ...
    with open(args.out, "a") as f:
        f.write("%d %d %d %d %.4f %.4f\n" %(args.id, success, collided, (curr_time - start_time)>=100, curr_time - start_time, nav_metric))
